...
import { formatCurrency, pnlColor, outcomeColor } from '@/lib/utils';
import {
  SortableHeader, SortField, SortDir,
...
export default function TradesTable({
  trades, isMobile, sortField, sortDir, onSort, onEdit, onDelete, onSelect,
}: TradesTableProps) {
